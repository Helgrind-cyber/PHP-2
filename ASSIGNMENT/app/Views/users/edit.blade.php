...
@section('page', 'Sửa người dùng')
@section('short_desc', '*: Không được để trống')

@section('main-content')
<div class="container">
    <form action="{{getClientUrl('user/save-edit')}}" method="post" enctype="multipart/form-data" id="createUser">
        <input type="hidden" name="id" value="{{$user->id}}">
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    <label for="name">Tên người dùng<span class="text-danger">*</span></label>
                    <input type="text" id="name" class="form-control" name="name" placeholder="Nhập tên người dùng" value="{{$user->name}}">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="email" class="form-control" name="email" placeholder="Nhập email người dùng" value="{{$user->email}}">
            ...
            <div class="col-md-6">
                ...
                <div class="row">
                    <div class="col-5 form-group">
                        <img src="{{BASE_URL . $user->avatar}}" id="preview-img" height="70%" class="img-thumbnail">
                    </div>
                    <div class="col-7 form-group">
                        <label for="avatar">Ảnh người dùng<span class="text-danger">*</span></label>
                        <input type="file" class="form-control-file" id="avatar" name="avatar" onchange="encodeImageFileAsURL(this)">
                    </div>
                    <div class="col-12">
                ...
                <div class="d-flex justify-content-end my-2">
                    <button type="submit" class="btn btn-outline-primary">Sửa người dùng</button>&nbsp;
...
<script>
    ...
    function encodeImageFileAsURL(element) {
        ...
        if (file === undefined) {
            $('#preview-img').attr('src', "{{$user->avatar}}");
            return false;
        }
